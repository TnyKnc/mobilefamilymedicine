...
function coerceRef(returnFiber, current$$1, element) {
  ...
  if (mixedRef !== null && typeof mixedRef !== 'function' && typeof mixedRef !== 'object') {
    ...
    if (element._owner) {
      ...
      if (owner) {
        var ownerFiber = owner;
        !(ownerFiber.tag === ClassComponent || ownerFiber.tag === ClassComponentLazy) ? invariant(false, 'Function components cannot have refs.') : void 0;
...
var validWrapperTypes = new Set([FunctionComponent, FunctionComponentLazy, ClassComponent, ClassComponentLazy, HostComponent, ForwardRef, ForwardRefLazy, PureComponent, PureComponentLazy,
